      ...
      <section className="border-b border-[#2a2a3a] py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-zinc-500 max-w-2xl">
            FractalNode Magazine is published monthly. Subscribe free for the digital edition,
            or order a printed copy. Every purchase sustains the Sovereign Lattice.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-lg bg-[#0e0e16] border border-[#2a2a3a] flex flex-col">
              <div className="flex items-center justify-between mb-4">
                <span className="text-[10px] font-mono text-[#39ff14] tracking-wider uppercase">Free</span>
                <span className="stamp stamp-declassified">OPEN ACCESS</span>
              </div>
              <h4 className="text-xl font-bold mb-1 text-zinc-200">Digital Edition</h4>
              <div className="text-3xl font-bold text-[#39ff14] my-4">$0</div>
              <ul className="space-y-2 mb-6 flex-grow">
                {[
                  "Monthly PDF delivered to your inbox",
          ...
          <div className="mt-8 p-6 rounded-lg bg-[#0c0c12] border border-[#2a2a3a]">
            ...
            <form name="print-order" method="POST" data-netlify="true" className="space-y-4">
